...
practices, includes comprehensive documentation, and has sufficient tests to
cover most use-cases.

- **Certified**: CyberArk Engineering officially supports the project and
guarantees that it conforms to secure development practices, includes
comprehensive documentation, and has sufficient tests to cover most use-cases.
...
- Basic documentation (e.g. a README.md file) that includes:
  ...
  - Description of project and covered use case(s)
  - Usage instructions
  - Supported versions of relevant dependencies / platforms
  - Known limitations
- Availability as a tagged version
  ...
  - For non-CyberArk software, versioned release artifacts will be uploaded to
    CyberArk Marketplace with the appropriate Certification Level
...
practices that are comparable to those used for our own internal development.
...
- Project has automated unit and / or integrations tests for all positive and
most negative test cases
...
- The build pipeline includes automated vulnerability scanning
- The NOTICES file is up-to-date and all licenses for dependencies have been
pre-approved (MIT, Apache 2.0, BSD) or individually approved by CyberArk legal.
